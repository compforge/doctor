...
4. Command 按诊断目标生成 Query 并驱动选中的 Inspect Capability，将返回数据保存为 Facts；RelationFact
...
6. Evidence Builder 组合 Inspect Facts、Capability Facts（含 RelationFact）与 Observations，纯 Detector/Coverage
   形成 Findings 和证据缺口。
