...
import {
  createServiceCatalog, modelBackendOutput, modelQueryOutput, modelResponseOutput, modelStreamOutput,
  type ServiceDefinition, type ModelQueryExtension
} from "../src";
...
test("legacy model discovery adapts operations without creating clients", () => {
  ...
  const service = {
    ...base,
    extensions: [...catalogExtensions({ endpoint, access: {}, create })]
  };
