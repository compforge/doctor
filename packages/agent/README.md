...
Skills do not have an independent installation lifecycle. A Plugin loader selects an exact Plugin version and passes
its resolved Skills to the agent. The agent never scans a global Skill directory or interprets Plugin storage layout.
